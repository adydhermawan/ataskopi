...
import 'package:ataskopi_frontend/features/checkout/presentation/screens/order_mode_selection_screen.dart';
...
class CheckoutSummaryScreen extends ConsumerWidget {
  ...
  void _showOrderModeSelectorModal(BuildContext context, WidgetRef ref) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const OrderModeSelectionScreen(isFromCheckout: true)),
    );
  }
}
