...
import 'package:flutter_riverpod/flutter_riverpod.dart'; // Force re-index check
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Outlet List
          Expanded(
            child: ref.watch(outletsProvider).when(
              data: (outlets) {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildOutletItem(
                      ...
                      distance: outlet.distance != null 
                        ? '${outlet.distance!.toStringAsFixed(1)} km' 
                        : '-',
                      isOpen: outlet.isActive,
              ...
              error: (err, stack) => Center(child: Text('Error loading outlets: $err')),
            ),
          ),
          // Confirm Button
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: ref.watch(selectedOutletProvider) != null ? () {
