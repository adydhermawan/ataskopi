...
class ProductRecommendationList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return productsAsync.when(
      data: (recommendedProducts) => SizedBox(
        height: 260.h,
      ...
      loading: () => SizedBox(height: 260.h, child: const Center(child: CircularProgressIndicator())),
      error: (e, s) => SizedBox(height: 260.h, child: const Center(child: Text('Gagal memuat produk'))),
    );
  }
}
