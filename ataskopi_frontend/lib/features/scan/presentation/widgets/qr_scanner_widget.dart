...
class _QrScannerWidgetState extends ConsumerState<QrScannerWidget> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    final pinColor = tenant.primaryColor;
    return Scaffold(
        ...
        children: [
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16.h),
                    const Text('Ketuk untuk mengaktifkan kamera', style: TextStyle(color: Colors.white, fontSize: 14)),
                    SizedBox(height: 16.h),
                    ElevatedButton(
          ...
          Positioned(
            ...
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                const Text('Arahkan kamera ke QR Code di meja', style: TextStyle(color: Colors.white, fontSize: 15)),
                ...
                Row(
                  ...
                  children: [
                    TextButton.icon(
                      ...
                      label: const Text('Ketik Manual', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                    ),
                    SizedBox(width: 12.w),
                    TextButton.icon(
                      ...
                      label: const Text('Upload Foto', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                    ),
                  ],
                ),
              ],
