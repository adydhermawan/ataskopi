                        ...
                        <div className="space-y-6 py-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>- Pengeluaran Cash (Bahan, Ops & Aset):</div><div className="text-right text-red-600">Rp {draftData.cashPurchases.toLocaleString('id-ID')}</div>
                                    {(draftData.assetPurchases || 0) > 0 && (
                                        <><div className="text-xs text-muted-foreground pl-4">↳ Termasuk Pembelian Aset:</div><div className="text-right text-xs text-muted-foreground">Rp {draftData.assetPurchases.toLocaleString('id-ID')}</div></>
                                    )}
