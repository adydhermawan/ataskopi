        ...
        <DialogContent className="sm:max-w-md bg-white border border-zinc-100 rounded-3xl shadow-2xl p-6 overflow-hidden">
          ...
          <div className="space-y-4 my-4">
            ...
            <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-100 space-y-3">
              <div>
                <p className="text-xs font-bold text-zinc-700 uppercase tracking-wider mb-1">Akses Uji Coba (Demo)</p>
              ...
              <Button
                asChild
                variant="outline"
                className="w-full rounded-full border-green-200 bg-green-50/50 hover:bg-green-100 hover:border-green-300 text-green-700 font-semibold transition-all h-10 cursor-pointer flex items-center justify-center gap-2 text-xs"
              >
                <Link href="https://wa.me/6282277999973?text=Halo%20AtasKopi,%20saya%20tertarik%20untuk%20mencoba%20demo%20web%20admin." target="_blank" rel="noopener noreferrer">
