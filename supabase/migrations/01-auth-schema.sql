...
-- Create auth.users table to satisfy foreign key constraints in public.profiles
-- This is usually handled by GoTrue, but needed here for concurrent initialization
